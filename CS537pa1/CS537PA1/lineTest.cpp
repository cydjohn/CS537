...
void _draw_circle_8( int xc, int yc, int x, int y,simpleCanvas &T) {
...
// (xc, yc) center，r raduis
void draw_circle(int xc, int yc, int r,simpleCanvas &T) {
    int x = 0, y = r,  d;
    d = 3 - 2 * r;
    
    
    while (x <= y) {
        _draw_circle_8(xc, yc, x, y,T);
        if (d < 0) {
            d = d + 4 * x + 6;
        } else {
            d = d + 4 * (x - y) + 10;
...
//    // ######## The letter 'O' in orange ########
    ...
    T.setColor( 0.678, 0.847, 0.902 );
    //    T.setColor(1, 0, 0);//red S
    
    //
    // YOUR CODE HERE
    //
    
    R.drawLine(140, 40, 180, 40, T);
    R.drawLine(180, 40, 180, 170, T);
    R.drawLine(180, 170, 280, 300, T);
    R.drawLine(280, 300, 240, 300, T);
    R.drawLine(240, 300, 160, 190, T);
    R.drawLine(160, 190, 80, 300, T);
    R.drawLine(80, 300, 40, 300, T);
    R.drawLine(40, 300, 140, 170, T);
    R.drawLine(140, 170, 140, 40, T);
    
    
    
    R.drawLine( 380, 40, 520, 40, T );   // Horizontal left to right
    R.drawLine( 340, 80, 380, 40, T );    // 315 degree slope
    R.drawLine( 520, 40, 560, 80, T );  // 45 degree slope
    R.drawLine( 560, 80, 560, 140, T );  // Vertical bottom to top
    R.drawLine( 560, 140, 520, 140, T );  // Horizontal right to left
    R.drawLine( 520, 140, 520, 100, T );
    R.drawLine( 520, 100, 500, 80, T );
    R.drawLine( 500, 80, 400, 80, T );
    R.drawLine( 400, 80, 380, 100, T );
    R.drawLine( 380, 100, 380, 200, T );
    R.drawLine( 380, 200, 400, 220, T );
    R.drawLine( 400, 220, 500, 220, T );
    R.drawLine( 500, 220, 520, 200, T );
    R.drawLine( 520, 200, 520, 180, T );
    R.drawLine( 520, 180, 560, 180, T );
    R.drawLine( 560, 180, 560, 220, T );
    R.drawLine( 560, 220, 520, 260, T );  // 135 degree slope
    R.drawLine( 520, 260, 380, 260, T );
    R.drawLine( 380, 260, 340, 220, T );    // 225 degree slope
    R.drawLine( 340, 220, 340, 80, T );    // Vertical top to bottom
